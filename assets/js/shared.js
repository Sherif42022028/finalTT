...
const DEFAULT_DOCTORS = [
  { id: 1, name: "Dr. Ahmed Mansour", specialty: "General physician", available: true, fee: 50, experience: "2 Years", degree: "MBBS, General Medicine", about: "Dedicated to providing comprehensive primary care with a patient-first approach.", img: "assets/images/M1.png", rating: 4.8, reviewsCount: 24, email: "ahmed@tabibi.com", certificates: [{name: 'Medical_Council_Certificate.png', type: 'image/png', data: '#'}] },
  { id: 2, name: "Dr. Maryam El-Gohary", specialty: "Gynecologist", available: true, fee: 70, experience: "5 Years", degree: "MBBS, MSc Gynecology", about: "Specialist in women's health with compassionate, evidence-based care.", img: "assets/images/F1.png", rating: 4.9, reviewsCount: 31, email: "maryam@tabibi.com" },
  { id: 3, name: "Dr. Aya Sami", specialty: "Dermatologist", available: false, fee: 60, experience: "4 Years", degree: "MBBS, Dermatology Board", about: "Expert in medical and cosmetic dermatology treatments.", img: "assets/images/F2.png", rating: 4.7, reviewsCount: 18, email: "aya@tabibi.com" },
  { id: 4, name: "Dr. Khaled Shouky", specialty: "Neurologist", available: true, fee: 90, experience: "8 Years", degree: "MBBS, Neurology Fellowship", about: "Specialist in neurological disorders and brain health.", img: "assets/images/M2.png", rating: 4.9, reviewsCount: 42, email: "khaled@tabibi.com" },
  { id: 5, name: "Dr. Youssef Nabil", specialty: "Pediatricians", available: true, fee: 55, experience: "3 Years", degree: "MBBS, Pediatrics", about: "Gentle, child-focused care for infants and adolescents.", img: "assets/images/image 419.png", rating: 4.8, reviewsCount: 27, email: "youssef@tabibi.com" }
];
